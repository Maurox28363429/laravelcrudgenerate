...
class productosDataTable extends DataTable
{
     ...
     *
     * @param \App\Models\productos $model
    ...
    {
        return [
            'name' => new Column(['title' => __('models/productos.fields.name'), 'data' => 'name']),
            'cantidad' => new Column(['title' => __('models/productos.fields.cantidad'), 'data' => 'cantidad'])
        ];
    }
