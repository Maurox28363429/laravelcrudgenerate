...
class asistenciaDataTable extends DataTable
{
    ...
    {
        return [
            'nombre' => new Column(['title' => __('models/asistencias.fields.nombre'), 'data' => 'nombre']),
            'cedula' => new Column(['title' => __('models/asistencias.fields.cedula'), 'data' => 'cedula'])
        ];
    }
    ...
    {
        return 'asistencias_datatable_' . time();
    }
}
